...
<div class="d-flex justify-content-end">
        <a href="<?php echo site_url('/registroduenodos') ?>" class="btn btn-success mb-2">Agregar Segundo Dueño</a>
	</div>
<div class="mt-3">
     <table class="table table-bordered" id="users-list">
       <thead>
       ...
       <tbody>
          ...
          <tr>
             <td><?php echo $reg->id; ?></td>
             <td><?php echo $reg->correoDueno; ?></td>
             <td><?php echo $reg->duenoTelefono1; ?></td>
             <td><?php echo $reg->duenoTelefono2; ?></td>
             <td>
              <a href="<?php echo site_url('/registroduenodos/editar01Formulario'.$reg->id);?>" class="btn btn-primary btn-sm">Editar</a>
              </td>
          </tr>
         <?php endforeach; ?>
         <?php endif; ?>
