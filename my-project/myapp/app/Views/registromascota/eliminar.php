...
<div class="container mt-5">
  <form method="post" id="add_create" name="add_create" action="<?= site_url('/registromascota-elimnar-continuar/') ?>">
    ...
    <h1 class="text-center">Eliminación de Mascota:</h1>
    <strong>
      <h5 class="text-danger">* Recuerde que al eliminar la mascota no se puede recuperar.</h5>
    </strong><br>
    ...
    <div class="form-group">
      ...
      <a href="<?php echo site_url('/registromascota-cancelar/'); ?>" class="btn btn-secondary btn-lg">Cancelar</a>
    </div>
  </form>
</div>
